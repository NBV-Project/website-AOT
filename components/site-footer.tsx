...
> = {
  ...
  en: {
    ...
    copyright: "© 2024 Asian Overseas Trading. All rights reserved.",
  },
  zh: {
    companyTitle: "企业信息",
    companyLinks: [
      { label: "法律条款", href: "/about" },
      { label: "隐私政策", href: "/about" },
      { label: "服务条款", href: "/about" },
    ],
    approachTitle: "运营方向",
    approachLinks: [
      { label: "可持续发展", href: "/logistics" },
      { label: "运输网络", href: "/logistics" },
      { label: "精选标准", href: "/logistics" },
    ],
    contactTitle: "联系我们",
    contactLinks: [
      { label: "总部地址", href: "/contact" },
      {
        label: "388/65-388/66 Nuan Chan Road, Nuan Chan, Bueng Kum, Bangkok 10230, 泰国",
        href: "https://maps.google.com/?q=388/65-388/66%20Nuan%20Chan%20Road%20Bueng%20Kum%20Bangkok%2010230",
        external: true,
      },
      { label: "电话: 085-289-2451", href: "tel:0852892451", external: true },
      { label: "邮箱: contact@asianoverseas.co.th", href: "mailto:contact@asianoverseas.co.th", external: true },
    ],
    copyright: "© 2024 亚洲海外贸易 版权所有",
  },
};
